...
import time
import pygame
from config import SMS_API_KEY, SMS_SENDER_ID  # Import from config file
    ...
    if "," in message:
        ...
        # Handle TELLER messages
            ...
            if action == "D":
                ...
                play_audio_sequence(next_token, "1", 'English')
                ...
                # Uncomment the next line to reset database (token count starts from 1)
                #reset_database()
            else:
